            ...
            <div className="mx-auto grid max-w-5xl border md:grid-cols-2">
                <div>
                    <div className="p-6 sm:p-12">
                        ...
                        <p className="mt-8 text-2xl font-semibold">Distributed rendering engine, built for instant cloud-scale video compilation.</p>
                    </div>
                    <div
                        aria-hidden
                        className="relative">
                        <div className="absolute inset-0 z-10 m-auto size-fit">
                            <div className="rounded-(--radius) bg-background z-1 dark:bg-muted relative flex size-fit w-fit items-center gap-2 border px-3 py-1 text-xs font-medium shadow-md shadow-zinc-950/5">
                                <span className="text-lg">⚡</span> Rendering in us-east-1
                            </div>
                ...
                <div className="overflow-hidden border-t bg-zinc-50 p-6 sm:p-12 md:border-0 md:border-l dark:bg-transparent">
                    <div className="relative z-10">
                        ...
                        <p className="my-8 text-2xl font-semibold">Just say what you want changed. Our AI handles the motion logic instantly.</p>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <span className="flex size-5 rounded-full border bg-muted-foreground/20">
                                </span>
                            ...
                            <div className="rounded-(--radius) bg-background mt-1.5 w-3/5 border p-3 text-xs">
                                Move the hero section to the top and add a fade-in.
                            </div>
                        </div>
                ...
                <div className="col-span-full border-y p-12">
                    <p className="text-center text-4xl font-semibold lg:text-7xl">0.2s Avg. Frame Time</p>
                </div>
                ...
                <div className="relative col-span-full">
                    <div className="absolute z-10 max-w-lg px-6 pr-12 pt-6 md:px-12 md:pt-12">
                        ...
                        <p className="my-8 text-2xl font-semibold">
                            Monitor your video&apos;s render progress in real-time.{' '}
                            <span className="text-muted-foreground"> Hollywood-grade exports, every single time.</span>
                        </p>
                    </div>
                    <MonitoringChart />
                </div>
